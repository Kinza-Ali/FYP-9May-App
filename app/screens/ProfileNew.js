...
class ProfileNew extends Component {
      ...
      state = {
        ...
        checked5:false,
        checked6:false,
        data:["Check Fasting Blood Sugar",
...
<View style={styles.user}>
    ...
    />
    <Text style={styles.headerDate}>Hey , {" "}
    ...
    <View style={{marginTop: perfectSize(25)}}>
        ...
        {/* {**************************************************************************}   */}
                ...
                <View style={{width: '100%',flexDirection: 'row',
                 justifyContent: 'space-around', marginTop: perfectSize(18)
                        }}>
                            <Neomorph
                            ...
                            darkShadowColor="#A8DEE0" // <- set this
                                ...
                                {height: perfectSize(80),width: perfectSize(100), borderRadius: perfectSize(18),
                                }]}
                            >
                ...
                <View style={{width: '100%',flexDirection: 'row', justifyContent: 'space-around', marginTop: perfectSize(18)}}>
                    ...
                    darkShadowColor="#FFC98B" // <- set this
                        swapShadows
                        style={[styles.menuIcons, {height: perfectSize(80),width: perfectSize(100), borderRadius: perfectSize(18)}]}
                    >
 ...
 {/* {**************************************************************************}   */}
                ...
                <View style={{
                    ...
                    darkShadowColor="#522157" // <- set this
                                swapShadows
                                style={[styles.menuIcons, {height: perfectSize(80),width: perfectSize(140),
                                 borderRadius: perfectSize(18)}]}
                            >
                            <Image
                                    source={Images.IBF}
     ...
     {/* {**************************************************************************}   */}
                ...
                justifyContent: 'space-around', marginTop: perfectSize(18)}}>
                    <Neomorph
                        swapShadows
                        style={[styles.menuIcons,
                        {borderRadius: perfectSize(18), height: perfectSize(56), 
