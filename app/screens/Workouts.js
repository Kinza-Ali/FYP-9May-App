              ...
              <TouchableOpacity onPress={() => navigation.navigate('FullBody')}>
                <LinearGradient
                  ...
                  <Image
                    ...
                    // source={require('../assests/images/bot.png')}
                  />
            ...
            <View style={styles.Button}>
              <TouchableOpacity onPress={() => navigation.navigate('Arms')}>
                <LinearGradient
                  ...
                  <Image
                    style={{width: 40, height: 40}}
                    // source={require('../assests/images/arm.png')}
                  />
                  <Text style={[styles.textSign, {color: 'white'}]}>
                    {' '}
                    Arm's Workout{' '}
            ...
            <View style={styles.Button}>
              <TouchableOpacity
                ...
                <LinearGradient
                  ...
                  <Image
                    style={{width: 40, height: 40}}
                    // source={require('../assests/images/shoulder.png')}
                  />
                  <Text style={[styles.textSign, {color: 'white'}]}>
                    {' '}
                    Shoulder's Workout{' '}
            ...
            <View style={styles.Button}>
              <TouchableOpacity onPress={() => navigation.navigate('Facial')}>
                <LinearGradient
                  ...
                  <Image
                    style={{width: 40, height: 40}}
                    // source={require('../assests/images/face.png')}
                  />
                  <Text style={[styles.textSign, {color: 'white'}]}>
                    {' '}
                    Facial Workouts{' '}
            ...
            <View style={styles.Button}>
              <TouchableOpacity onPress={() => navigation.navigate('WarmUp')}>
                <LinearGradient
                  ...
                  <Image
                    style={{width: 40, height: 40}}
                    // source={require('../assests/images/warmup.png')}
                  />
                  <Text style={[styles.textSign, {color: 'white'}]}>
                    {' '}
                    Warm Up{' '}
